@echo off
echo 🚀 DÉPLOIEMENT avec ENTRYPOINT CORRECT
...
echo ⬆️ Déploiement avec l'ENTRYPOINT correct...
railway deploy --service kestra --dockerfile Dockerfile.railway.ENTRYPOINT-CORRECT
...
echo 💡 Cette fois on utilise l'ENTRYPOINT correct de l'image officielle!
pause
